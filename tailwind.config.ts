  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        nixacom: {
          blue: "hsl(var(--nixacom-blue))",
          "blue-light": "hsl(var(--nixacom-blue-light))",
          "blue-dark": "hsl(var(--nixacom-blue-dark))",
        },
        stepper: {
        ...
        doc: {
          complete: "hsl(var(--doc-complete))",
          partial: "hsl(var(--doc-partial))",
          missing: "hsl(var(--doc-missing))",
        },
      },
      borderRadius: {
        lg: "var(--radius)",
